...
export const HeroSection = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen min-h-[100dvh] flex items-center justify-center overflow-hidden pt-20 md:pt-0">
      ...
      <div className="container mx-auto px-4 sm:px-6 text-center z-10 relative pb-16">
        <motion.div
      ...
      <motion.button
        ...
        className="absolute bottom-8 md:bottom-12 left-1/2 -translate-x-1/2 text-gray-400 z-10"
        animate={{ y: [0, 10, 0] }}
